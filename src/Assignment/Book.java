...
public class Book {
    ...
    public String toString() {
        return "Book Information: Title " + title + ", Author " + author + ", Publication year " + publicationYear
                + ", Number of pages " + pages + ". Is the Book in the Fiction or Non-Fiction category: " + category
                + ".\n";
    }
